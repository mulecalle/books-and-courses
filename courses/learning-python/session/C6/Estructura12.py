...
class MiApp:
    ...
    def __init__(self, parent=None, **configs):
        ...
        self.seccion_representacion = Frame(self.Contenedor, bg="red",
        borderwidth=2, relief=RAISED)
        ...
        Label(self.expand_contenedor, borderwidth=4, relief=RAISED,
             text="Expand", bg="#222",fg="OrangeRed",).pack(fill=X)
        Label(self.anchor_contenedor, borderwidth=4, relief=RAISED,
             text="Anchor", bg="#222",fg="OrangeRed",).pack(fill=X)
        ...
        self.deslizador_central = Frame(self.representacion_superior,
                           background="black",
                           borderwidth=7,
                           relief=SUNKEN,
                           width=250
        ...
        self.deslizador_vertical = Frame(self.representacion_superior,
                          background="#FF7F50",
                          borderwidth=5,
                          relief=SUNKEN,
                          width=50,
