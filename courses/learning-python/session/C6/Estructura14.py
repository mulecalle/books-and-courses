...
class MiApp:
    ...
    def __init__(self, parent=None, **configs):
        ...
        self.deslizador_central = Frame(self.representacion_superior, background="black", borderwidth=4, relief=SUNKEN, width=250)
        self.deslizador_central.pack(side=LEFT, expand=YES, fill=BOTH)

        self.deslizador_vertical = Frame(self.representacion_superior, background="#FF7F50", borderwidth=4, relief=SUNKEN, width=50)
        self.deslizador_vertical.pack(side=RIGHT, expand=NO, fill=Y)

        self.deslizador_horizontal = Frame(self.representacion, borderwidth=4, relief=SUNKEN, height=50, bg="OrangeRed")
        ...
        # ##################### #
        for opcion in temas:
            boton = Radiobutton(self.temas_opciones, text=str(opcion), indicatoron=1, value=opcion, bg="#222", fg="OrangeRed")
