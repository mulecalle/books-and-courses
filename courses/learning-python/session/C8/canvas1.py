...
# Crear un arco #
#################
canvas.create_arc(60, 60, 140, 100, start=0, extent=210, outline="#f11", fill="#1f1", width=2)
canvas.create_arc(200, 60, 280, 100, start=-20, extent=200, outline="#f11", fill="#1f1", width=2)
